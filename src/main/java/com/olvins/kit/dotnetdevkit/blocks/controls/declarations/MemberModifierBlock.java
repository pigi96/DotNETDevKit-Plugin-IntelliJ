...
@BlockBuilder
public class MemberModifierBlock extends Block implements ISimpleBlock {
    private final static String CODE_TEMPLATE = BlockType.STRING_BLOCK.getValue();

    public MemberModifierBlock(String classModifier) {
        super(CODE_TEMPLATE, BlockType.MEMBER_MODIFIER_BLOCK, new Validators.MemberModifierValidator(), classModifier);
    }
}
